...
export default function Root({children}) {
  useEffect(() => {
    // Инициализировать cookie consent после гидратации
    const initCookieConsent = async () => {
      // Дождаться загрузки модуля
      const { default: CookieConsent } = await import('/assets/vendor/cookieconsent/cookieconsent.esm.js');
